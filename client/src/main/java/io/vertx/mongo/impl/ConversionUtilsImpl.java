...
public class ConversionUtilsImpl implements ConversionUtils {
    ...
    @Override
    public BsonDateTime toBsonDateTime(Instant from) {
        return new BsonDateTime(from.toEpochMilli());
    }
    ...
    @Override
    public byte[] toByteArray(Buffer from) {
    ...
    @Override
    public Instant toInstant(BsonDateTime from) {
        return Instant.ofEpochMilli(from.getValue());
    }
