...
import io.vertx.mongo.client.ListIndexesResult;
...
public class MongoCollectionImpl<TDocument> extends MongoCollectionBase<TDocument> {
  ...
  @Override
  public FindResult<TDocument> find() {
    FindPublisher<TDocument> __publisher = wrapped.find();
    return new FindResultImpl<>(clientContext, __publisher, outputMapper);
  }

  @Override
  public FindResult<TDocument> find(FindOptions options) {
    FindPublisher<TDocument> __publisher = wrapped.find();
    options.initializePublisher(clientContext, __publisher);
    Integer __batchSize = options.getBatchSize();
    if (__batchSize != null) {
      return new FindResultImpl<>(clientContext, __publisher, outputMapper, __batchSize);
    } else {
      return new FindResultImpl<>(clientContext, __publisher, outputMapper);
    }
  }
  ...
  @Override
  public FindResult<TDocument> find(JsonObject filter) {
    requireNonNull(filter, "filter is null");
    Bson __filter = clientContext.getMapper().toBson(filter);
  ...
  @Override
  public FindResult<TDocument> find(JsonObject filter, FindOptions options) {
    requireNonNull(filter, "filter is null");
    Bson __filter = clientContext.getMapper().toBson(filter);
    FindPublisher<TDocument> __publisher = wrapped.find(__filter);
    options.initializePublisher(clientContext, __publisher);
  ...
  @Override
  public FindResult<TDocument> find(ClientSession clientSession) {
    requireNonNull(clientSession, "clientSession is null");
    com.mongodb.reactivestreams.client.ClientSession __clientSession = clientSession.toDriverClass(clientContext);
  ...
  @Override
  public FindResult<TDocument> find(ClientSession clientSession, FindOptions options) {
    requireNonNull(clientSession, "clientSession is null");
    com.mongodb.reactivestreams.client.ClientSession __clientSession = clientSession.toDriverClass(clientContext);
    FindPublisher<TDocument> __publisher = wrapped.find(__clientSession);
    options.initializePublisher(clientContext, __publisher);
  ...
  @Override
  public FindResult<TDocument> find(ClientSession clientSession, JsonObject filter) {
    requireNonNull(clientSession, "clientSession is null");
    requireNonNull(filter, "filter is null");
    com.mongodb.reactivestreams.client.ClientSession __clientSession = clientSession.toDriverClass(clientContext);
    Bson __filter = clientContext.getMapper().toBson(filter);
  ...
  @Override
  public AggregateResult<TDocument> aggregate(JsonArray pipeline) {
    ...
    return new AggregateResultImpl<>(clientContext, __publisher, outputMapper);
  }

  @Override
  public AggregateResult<TDocument> aggregate(JsonArray pipeline, AggregateOptions options) {
    requireNonNull(pipeline, "pipeline is null");
    List<? extends Bson> __pipeline = clientContext.getMapper().toBsonList(pipeline);
    AggregatePublisher<TDocument> __publisher = wrapped.aggregate(__pipeline);
    options.initializePublisher(clientContext, __publisher);
    Integer __batchSize = options.getBatchSize();
    if (__batchSize != null) {
      return new AggregateResultImpl<>(clientContext, __publisher, outputMapper, __batchSize);
    } else {
      return new AggregateResultImpl<>(clientContext, __publisher, outputMapper);
    }
  }
  ...
  @Override
  public AggregateResult<TDocument> aggregate(ClientSession clientSession, JsonArray pipeline) {
    requireNonNull(clientSession, "clientSession is null");
    requireNonNull(pipeline, "pipeline is null");
    com.mongodb.reactivestreams.client.ClientSession __clientSession = clientSession.toDriverClass(clientContext);
    List<? extends Bson> __pipeline = clientContext.getMapper().toBsonList(pipeline);
  ...
  @Override
  public MapReduceResult<TDocument> mapReduce(String mapFunction, String reduceFunction) {
    ...
    return new MapReduceResultImpl<>(clientContext, __publisher, outputMapper);
  }
  ...
  public MapReduceResult<TDocument> mapReduce(String mapFunction, String reduceFunction,
    ...
    Integer __batchSize = options.getBatchSize();
    if (__batchSize != null) {
      return new MapReduceResultImpl<>(clientContext, __publisher, outputMapper, __batchSize);
    } else {
      return new MapReduceResultImpl<>(clientContext, __publisher, outputMapper);
    }
  }
  ...
  @Override
  public MapReduceResult<TDocument> mapReduce(ClientSession clientSession, String mapFunction,
  ...
  @Override
  public ListIndexesResult<JsonObject> listIndexes() {
    ListIndexesPublisher<JsonObject> __publisher = wrapped.listIndexes(JsonObject.class);
    return new ListIndexesResultImpl<>(clientContext, __publisher, clientContext.getConfig().getOutputMapper());
  }

  @Override
  public ListIndexesResult<JsonObject> listIndexes(ListIndexesOptions options) {
    ListIndexesPublisher<JsonObject> __publisher = wrapped.listIndexes(JsonObject.class);
    options.initializePublisher(clientContext, __publisher);
    Integer __batchSize = options.getBatchSize();
    if (__batchSize != null) {
      return new ListIndexesResultImpl<>(clientContext, __publisher, clientContext.getConfig().getOutputMapper(), __batchSize);
    } else {
      return new ListIndexesResultImpl<>(clientContext, __publisher, clientContext.getConfig().getOutputMapper());
    }
  }
  ...
  @Override
  public ListIndexesResult<JsonObject> listIndexes(ClientSession clientSession) {
    requireNonNull(clientSession, "clientSession is null");
    com.mongodb.reactivestreams.client.ClientSession __clientSession = clientSession.toDriverClass(clientContext);
