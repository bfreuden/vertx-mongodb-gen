...
public interface MongoDatabase {
   ...
   */
  ListCollectionsResult<JsonObject> listCollections();
   ...
   *  @mongodb.driver.manual reference/command/listCollections listCollections
   */
  ListCollectionsResult<JsonObject> listCollections(ListCollectionsOptions options);
   ...
   *  @since 1.7
   */
  ListCollectionsResult<JsonObject> listCollections(ClientSession clientSession);
   ...
   *  @mongodb.server.release 3.6
   */
  AggregateResult<JsonObject> aggregate(JsonArray pipeline);
   ...
   *  @mongodb.server.release 3.6
   */
  AggregateResult<JsonObject> aggregate(JsonArray pipeline, AggregateOptions options);
   ...
   *  @mongodb.server.release 3.6
   */
  AggregateResult<JsonObject> aggregate(ClientSession clientSession, JsonArray pipeline);
