...
public interface MongoClient extends Closeable {
   ...
   */
  ListDatabasesResult<JsonObject> listDatabases();
   ...
   *  @return the fluent list databases interface
   */
  ListDatabasesResult<JsonObject> listDatabases(ListDatabasesOptions options);
   ...
   *  @since 1.7
   */
  ListDatabasesResult<JsonObject> listDatabases(ClientSession clientSession);
