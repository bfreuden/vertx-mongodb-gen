...
public interface MongoCollection<TDocument> {
   ...
   *  @mongodb.driver.manual tutorial/query-documents/ Find
   */
  FindResult<TDocument> find(FindOptions options);
   ...
   *  @mongodb.driver.manual tutorial/query-documents/ Find
   */
  FindResult<TDocument> find(JsonObject filter);
   ...
   *  @mongodb.driver.manual tutorial/query-documents/ Find
   */
  FindResult<TDocument> find(JsonObject filter, FindOptions options);
   ...
   *  @since 1.7
   */
  FindResult<TDocument> find(ClientSession clientSession);
   ...
   *  @since 1.7
   */
  FindResult<TDocument> find(ClientSession clientSession, FindOptions options);
   ...
   *  @since 1.7
   */
  FindResult<TDocument> find(ClientSession clientSession, JsonObject filter);
   ...
   *  @since 1.7
   */
  FindResult<TDocument> find(ClientSession clientSession, JsonObject filter, FindOptions options);
   ...
   */
  AggregateResult<TDocument> aggregate(JsonArray pipeline);
   ...
   *  @mongodb.driver.manual aggregation/ Aggregation
   */
  AggregateResult<TDocument> aggregate(JsonArray pipeline, AggregateOptions options);
   ...
   *  @since 1.7
   */
  AggregateResult<TDocument> aggregate(ClientSession clientSession, JsonArray pipeline);
   ...
   *  @since 1.7
   */
  ChangeStreamResult<JsonObject> watch();
   ...
   *  @since 1.7
   */
  ChangeStreamResult<JsonObject> watch(ChangeStreamOptions options);
   ...
   *  @since 1.6
   */
  ChangeStreamResult<JsonObject> watch(JsonArray pipeline);
   ...
   *  @since 1.7
   */
  ChangeStreamResult<JsonObject> watch(ClientSession clientSession);
   ...
   */
  MapReduceResult<TDocument> mapReduce(String mapFunction, String reduceFunction);
   ...
   *  @deprecated Superseded by aggregate
   */
  MapReduceResult<TDocument> mapReduce(ClientSession clientSession, String mapFunction,
   ...
   */
  ListIndexesResult<JsonObject> listIndexes();
   ...
   *  @mongodb.driver.manual reference/command/listIndexes/ listIndexes
   */
  ListIndexesResult<JsonObject> listIndexes(ListIndexesOptions options);
   ...
   *  @since 1.7
   */
  ListIndexesResult<JsonObject> listIndexes(ClientSession clientSession);
