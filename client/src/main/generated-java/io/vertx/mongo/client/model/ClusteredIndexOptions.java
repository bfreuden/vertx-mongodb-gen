...
public class ClusteredIndexOptions {
  ...
  public com.mongodb.client.model.ClusteredIndexOptions toDriverClass(
    ...
    com.mongodb.client.model.ClusteredIndexOptions result = new com.mongodb.client.model.ClusteredIndexOptions(clientContext.getMapper().toBson(this.key), this.unique);
    if (this.name != null) {
