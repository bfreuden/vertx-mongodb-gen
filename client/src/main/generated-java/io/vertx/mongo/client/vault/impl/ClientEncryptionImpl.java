...
import io.vertx.mongo.client.impl.FindResultImpl;
...
public class ClientEncryptionImpl extends ClientEncryptionBase {
  ...
  @Override
  public FindResult<JsonObject> getKeys() {
    FindPublisher<BsonDocument> __publisher = wrapped.getKeys();
    Function<BsonDocument, JsonObject> _toJson = clientContext.getMapper()::toJsonObject;
    //FIXME
    throw new IllegalStateException("TODO");
//    return new FindResultImpl<>(clientContext, __publisher, _toJson.andThen(clientContext.getConfig().getOutputMapper()));
  }

  @Override
  public FindResult<JsonObject> getKeys(FindOptions options) {
    FindPublisher<BsonDocument> __publisher = wrapped.getKeys();
    Function<BsonDocument, JsonObject> _toJson = clientContext.getMapper()::toJsonObject;
    ...
    throw new IllegalStateException("TODO");
//    if (__batchSize != null) {
//      return new FindResultImpl<>(clientContext, __publisher, _toJson.andThen(clientContext.getConfig().getOutputMapper()), __batchSize);
//    } else {
//      return new FindResultImpl<>(clientContext, __publisher, _toJson.andThen(clientContext.getConfig().getOutputMapper()));
//    }
  }
