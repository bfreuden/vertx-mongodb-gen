...
javadoc -link https://javadoc.io/doc/io.vertx/vertx-core/latest/ \
  ...
  -verbose \
  -classpath /home/bruno/.sdkman/candidates/java/8.0.302-open/lib/tools.jar:target/dependencies/mongodb-driver-core-4.1.2.jar:target/dependencies/mongodb-driver-reactivestreams-4.1.2.jar:target/dependencies/vertx-core-4.3.2.jar:target/dependencies/vertx-codegen-4.3.2.jar:target/dependencies/bson-4.1.2.jar:target/dependencies/reactive-streams-1.0.2.jar:target/classes -sourcepath src/main/java \
  -d javadoc \
  -public \
